// Covers the HotkeyBinding value object: normalization to a canonical chord, the resulting
// order-insensitive structural equality, and rejection of empty / key-less bindings (the invariant
// the settings validator leans on).
