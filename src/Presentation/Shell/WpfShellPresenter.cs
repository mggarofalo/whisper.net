// IShellPresenter for the WPF shell: shows — or focuses, if
// already open — the single dashboard window, marshaled onto the UI thread through the IUiDispatcher
// seam rather than a hand-rolled call against the live application's dispatcher. Both the tray "Open
// Settings" action and single-instance activation surface the window through this one seam.
