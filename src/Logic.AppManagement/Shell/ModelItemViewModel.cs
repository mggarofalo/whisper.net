...
//
// Each row OWNS its download (WHISPER-107): the Download/Cancel commands, progress, terminal state, and
...
public sealed partial class ModelItemViewModel : ObservableObject
{
	...
	/// failure never masks another's progress (WHISPER-107).</summary>
	[ObservableProperty]
	...
	// is exactly what WHISPER-107 wants. IncludeCancelCommand generates DownloadCancelCommand, which
