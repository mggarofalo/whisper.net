// The visual state the dictation overlay communicates, so the user can tell at a glance
...
public enum OverlayState
{
	...
	/// <summary>The dictation model is warming up; shown while the warm-up runs, until it
