// Port for surfacing the app's window to the user. Implemented in Presentation (the WPF
// shell) and faked in specs. Kept deliberately small: the tray "Open Settings" action and, later,
// single-instance activation both just need to bring the settings window to the
