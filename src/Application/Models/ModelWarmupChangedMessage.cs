// Published on the shared IMessenger when the dictation model's warm-up starts and again
// when it ends — the single app-wide signal the UI uses to show a "warming up" cue and then clear it
//. IsWarming is true when a warm-up begins and false when it ends (success, failure, OR
