...
// signals fire — the limit is SOFT: recording continues and nothing is dropped, the
...
// the default target); and how long to keep capturing after the stop signal so the
